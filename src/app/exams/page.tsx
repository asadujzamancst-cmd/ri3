...
export default function ExamManagementPage() {
  ...
  const fetchExams = async () => {
    const res = await fetch('https://institutemanagement3.onrender.com/exams/exams/')
    const data = await res.json()
    setExams(data)
  }

  const fetchQuestions = async (examId: number) => {
    const res = await fetch(`https://institutemanagement3.onrender.com/exams/questions/?exam_id=${examId}`)
    const data = await res.json()
    setQuestions(data)
  }
  ...
  const handleExamSubmit = async () => {
    const url = editingExamId
      ? `https://institutemanagement3.onrender.com/exams/exams/${editingExamId}/`
      : 'https://institutemanagement3.onrender.com/exams/exams/'
  ...
  const handleDeleteExam = async (id: number) => {
    await fetch(`https://institutemanagement3.onrender.com/exams/exams/${id}/`, { method: 'DELETE' })
  ...
  const handleQuestionSubmit = async () => {
    ...
    const url = editingQuestionId
      ? `https://institutemanagement3.onrender.com/exams/questions/${editingQuestionId}/`
      : 'https://institutemanagement3.onrender.com/exams/questions/'
  ...
  const handleDeleteQuestion = async (id: number) => {
    await fetch(`https://institutemanagement3.onrender.com/exams/questions/${id}/`, { method: 'DELETE' })
    fetchQuestions(selectedExamId!)
  }
