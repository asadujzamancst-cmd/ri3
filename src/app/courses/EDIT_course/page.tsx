...
export default function CourseListPage() {
  ...
  const fetchCourses = async () => {
    try {
      const res = await fetch("https://institutemanagement3.onrender.com/course/course/");
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const res = await fetch(`https://institutemanagement3.onrender.com/course/course/${id}/`, {
        method: "DELETE",
      });
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`https://institutemanagement3.onrender.com/course/course/${editingCourse.id}/`, {
        method: "PUT",
