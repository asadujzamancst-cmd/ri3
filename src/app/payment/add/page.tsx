...
useEffect(() => {
fetch('[https://institutemanagement3.onrender.com/payment/students/](https://institutemanagement3.onrender.com/payment/students/)')
.then((res) => res.json())
.then(setStudents)
...
try {
  await fetch('https://institutemanagement3.onrender.com/payment/payments/', {
    method: 'POST',
